  ...
  return (
    <>
      <Transition
        ...
        afterLeave={() => setQuery('')}
      >
        <Combobox.Options className="tw-absolute tw-z-10 tw-max-h-[210px] tw-w-full tw-overflow-auto tw-bg-white tw-pb-[10px] tw-pt-[10px] tw-text-base tw-shadow-[0_1px_6px_0_rgba(0,0,0,0.5)] focus:tw-outline-none sm:tw-text-sm">
          {children}
        </Combobox.Options>
      </Transition>
    </>
